...
- 로비/대기방 BGM: `public/audio/Cardboard Thunder.mp3`
- 게임 진행 BGM: `public/audio/Croatian Rhapsody.mp3`
...
로비와 대기방에서는 `Cardboard Thunder.mp3`가 반복 재생되고, 게임이 시작되어 라운드/결과/최종 결과 화면으로 들어가면 `Croatian Rhapsody.mp3`로 전환됩니다. 다시하기로 대기방에 돌아가거나 방에서 나가 로비로 돌아가면 로비 BGM으로 돌아갑니다.
